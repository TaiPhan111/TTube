...
public class AbstractDao<T> {
	...
	public T create(T entity) {
		try {
			...
			System.out.println("Cannot insert entity "+ entity.getClass()+ " to DB");
	...
	public T update(T entity) {
		try {
			...
			entityManager.getTransaction().rollback();
			System.out.println("Cannot update entity "+ entity.getClass()+ " to DB");
			throw new RuntimeException(e);
		}
	}
	public T delete(T entity) {
		try {
			...
			entityManager.getTransaction().rollback();
			System.out.println("Cannot delete entity "+ entity.getClass()+ " to DB");
			throw new RuntimeException(e);
		}
	}
